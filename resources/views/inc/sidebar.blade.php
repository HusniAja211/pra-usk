    ...
    <div class="navbar-wrapper">
        ...
        <div class="navbar-content">
            <ul class="pc-navbar">
                ...
                @auth
                    <li class="pc-item">
                        <a href="{{ auth()->user()->role == 'admin' ? route('admin.dashboard.index') : route('user.dashboard.index')}}" class="pc-link"><span class="pc-micon"> <i
                                    class="ph ph-gauge"></i></span><span class="pc-mtext">Dashboard</span></a>
                    </li>
                    @if (auth()->user()->role == 'admin')
                        {{-- ADMIN START --}}
                        <li class="pc-item">
                            <a href="{{route('member.index')}}" class="pc-link"><span class="pc-micon"> <i
                        ...
                        <li class="pc-item pc-hasmenu">
                            ...
                            <ul class="pc-submenu">
                                <li class="pc-item"><a class="pc-link" href="#!"><i class="ph ph-squares-four"></i>
                                        Categories</a></li>
                                <li class="pc-item"><a class="pc-link" href="#!"><i class="ph ph-book-open"></i>
                                        Books</a></li>
                            </ul>
                        </li>
                        <li class="pc-item pc-hasmenu">
                            <a href="#!" class="pc-link"><span class="pc-micon"> <i class="ph ph-credit-card"></i>
                                        ...
                                        data-feather="chevron-right"></i></span></a>
                            <ul class="pc-submenu">
                                <li class="pc-item"><a class="pc-link" href="#!"><i class="ph ph-money"></i> Payment
                                        Books</a></li>
                    ...
                    @elseif(auth()->user()->role == 'user')
                        {{-- USER START --}}
                        <li class="pc-item">
                            <a href="" class="pc-link"><span class="pc-micon"> <i class="ph ph-info"></i></span><span
                        ...
                        <li class="pc-item">
                            <a href="" class="pc-link"><span class="pc-micon"> <i
                                        class="ph ph-magnifying-glass"></i></span><span class="pc-mtext">Search
                                    book</span></a>
                        </li>
                        {{-- USER END --}}
                    @endif
